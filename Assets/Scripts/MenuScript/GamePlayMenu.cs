...
public class GamePlayMenu : MonoBehaviour {
    ...
    public void PauseAndResumeGame () {
        ...
        if (GamePauseUI.activeSelf) {
            ...
            _Ads.instance.ShowInterstitialAd("",delegate {  });
            Time.timeScale = 0f;
    ...
    void Update () 
    {
        ...
        if (rewardedAdShown && _Ads.instance.isRewarded)
        {
            hideControlUI = true;
            Time.timeScale = 1f;
    ...
    public void LoadScene (int sceneIndex) {
        ...
        if (sceneIndex != 0 && _Ads.instance.Is_RewardedVideoAvalaible())
        {
            _Ads.instance.ShowRewardedAd("",delegate(bool b) {  });
